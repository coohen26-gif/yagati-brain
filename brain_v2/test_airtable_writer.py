...
class TestAirtableTokenNormalization(unittest.TestCase):
    ...
    def test_token_with_double_bearer_prefix(self):
        """Test that double Bearer prefix is normalized (removes first occurrence)"""
        ...
        # Our implementation removes the first "Bearer " and adds it back,
        # resulting in "Bearer Bearer keyABC123XYZ" -> "Bearer keyABC123XYZ"
        # This correctly handles the edge case!
        expected = "Bearer keyABC123XYZ"
        actual = writer.headers["Authorization"]
